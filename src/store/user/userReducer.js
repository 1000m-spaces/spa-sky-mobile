...
const initializeState = {
  ...
  listUserAffiliate: [],
  statusGetListUserAffi: Status.DEFAULT,
};
...
export default (state = initializeState, {type, payload}) => {
  switch (type) {
    ...
    case NEOCAFE.GET_LIST_USER_AFFILIATE_REQUEST:
      return {
        ...state,
        statusGetListUserAffi: Status.DEFAULT,
      };
    case NEOCAFE.GET_LIST_USER_AFFILIATE_SUCCESS:
      return {
        ...state,
        listUserAffiliate: payload,
        statusGetListUserAffi: Status.SUCCESS,
      };
    case NEOCAFE.GET_LIST_USER_AFFILIATE_ERROR:
      return {
        ...state,
        listUserAffiliate: [],
        statusGetListUserAffi: Status.ERROR,
      };
    default:
      return state;
  }
